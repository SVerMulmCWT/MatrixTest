...
public class LoginPage extends LoginLocators {
	...
	public void SSOSignin(String environment, String userid, String password) {
		//Output to the system and report
		System.out.println("Attempting to log into -> " + environment);
		reportLogger.log(LogStatus.INFO, "Attempting to log into -> " + environment);
		...
		try {
			...
			//Enter CWT VPN/Connection Credentials
			cwtUserIDField.sendKeys(userid);
			System.out.println("B");
			cwtPasswordField.sendKeys(password);
			System.out.println("C");
			//Click to Sign in to CWT VPN/Connection
			cwtLoginButton.click();
		...
		//
		eDriver.findElement(By.xpath("//select[@id='MainContent_ddlRegion']/option[contains(text(), '" + environment + "')]")).click();
//		eDriver.findElement(By.xpath("//select[@id='MainContent_ddlRegion']/option[contains(text(), 'US Commercial')]")).click();
		
		if (environment == "US Commercial") {
			myMatrixUSComm.click();
		} else {
			myMatrixCA.click();
		}
	...
	public void signout(String environment) {
		//Output to the system and report
		System.out.println("Attempting to sign out of -> " + environment);
		reportLogger.log(LogStatus.INFO, "Attempting to sign out of -> " + environment);
